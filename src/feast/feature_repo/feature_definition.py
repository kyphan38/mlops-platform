...
listing_fv = FeatureView(
  ...
  schema=[
    ...
    Field(name="accommodates", dtype=Int64),
    Field(name="bathrooms", dtype=Float64),
    Field(name="bedrooms", dtype=Float64),
    Field(name="beds", dtype=Float64),
    Field(name="amenities", dtype=String),
    Field(name="price", dtype=Float64),
    Field(name="has_availability", dtype=Float64),
    Field(name="availability_30", dtype=Int64),
    Field(name="availability_60", dtype=Int64),
    Field(name="availability_90", dtype=Int64),
